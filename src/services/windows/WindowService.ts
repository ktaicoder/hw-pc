...
import { IMenuService } from '../menu/IMenuService'
...
export class WindowService implements IWindowService {
  ...
  @lazyInject(serviceIdentifier.Menu) //
    ...
    if (existedWindow !== undefined) {
      if (
        ...
        (typeof recreate === 'function' &&
          existedWindowMeta !== undefined &&
          recreate(existedWindowMeta))
      ) {
        existedWindow.close()
      } else {
  ...
  public async setWindowMeta<N extends WindowNames>(
    windowName: N,
    meta: WindowMeta[N],
  ): Promise<void> {
  ...
  public async updateWindowMeta<N extends WindowNames>(
    windowName: N,
    meta: WindowMeta[N],
  ): Promise<void> {
  ...
  public async getWindowMeta<N extends WindowNames>(
    windowName: N,
  ): Promise<WindowMeta[N] | undefined> {
