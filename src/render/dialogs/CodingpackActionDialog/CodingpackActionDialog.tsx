...
import ReactConsole, { ReactConsoleControl } from 'src/render/components/ReactConsole/ReactConsole'
          ...
          {!loading && !initialReady && !promptReady && (
            ...
            >
              ...
              {terminalLineCount < 1 && (
                <>
                  <Box p={2}>
                    <Typography variant="subtitle1" sx={{ fontSize: '1.1rem', textAlign: 'center' }}>
                      코디니팩과 연결이 안되는 것 같습니다.
                    </Typography>
                  </Box>
                  <Box px={4}>
                    <Typography variant="body1" sx={{ color: 'secondary.main', fontSize: '0.85rem' }}>
                      아래 내용을 체크해주세요
                    </Typography>
                  </Box>
                  <Box
                  ...
                  >
                    ...
                    <ul>
                      ...
                      <li>확인을 위해 코디니팩의 버튼을 누른 채로 4~5초 정도 기다리면 음성으로 알려줍니다.</li>
                    </ul>
                    ...
                    <ul>
                      ...
                      <li>윈도우인 경우 제어판의 장치 관리자에서 장치가 인식되었는지 확인할 수 있습니다.</li>
                    </ul>
                  </Box>
                </>
              )}
