...
export interface IHcpFirmataNotificationManager extends IHcpHwNotificationManager {
  notify(payload: HwNotificationPayload): void
  observe(): Observable<HwNotificationPayload>
}
