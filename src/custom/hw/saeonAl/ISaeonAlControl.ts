 ...
 */
export interface ISaeonAlControl {
  /**
   * 정지
   * option : All
   * option : Drive
   ...
   * option : IR6
   * option : Temperature
   * option : M-Current Left
   * option : M-Current Right
   * option : S-Current
   * option : BAT
   */
  ...
  /**
   * 라이트
   * breakHex : break light hex value
   * ledHex : forward / turn left / turn right / reverse light hex value
   */
  lightHex(ctx: any, breakHex: number, ledHex: number): Promise<void>
