 ...
 */
export class SaeonAlParser extends Transform {
  // 중개 버퍼
  ...
  // 시작 마크
  private readonly startMark = 0x02

  // 종료 마크
  private readonly endMark = 0x03

  // 56바이트를 채워서 보냅니다
  private readonly packetLength = 56
