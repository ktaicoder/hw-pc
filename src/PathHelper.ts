...
const menuBarIconFileName =
  process.platform === 'darwin' ? 'menubarTemplate@2x.png' : 'menubar@2x.png'
...
export class PathHelper {
  ...
  static indexJsPath = () => {
    ...
    // c:/users/jjfive/AppData/Local/aicodiny_hw/app-1.0.0/resource/app/.webpack/main/index.js
    return INDEX_JS_FOLDER
  }

  static appPath = (...subpath: (string | undefined)[]) => {
    // DEV: d:/p2/codiny/aicoding-hw
    // PROD: c:/users/jjfive/AppData/Local/aicodiny_hw/app-1.0.0/resource/app
   ...
   * 사용자 홈의 .aicodiny 경로
   */
  static userConfigPath = (...subpath: (string | undefined)[]) => {
    return joinPath(app.getPath('home'), '.aicodiny', ...subpath)
  }
  ...
  static driversPath = (...subpath: (string | undefined)[]): string => {
    return PathHelper.webRootPath('static/drivers', ...subpath)
  }
